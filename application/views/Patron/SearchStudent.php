        ...
        <div class="col-md-10">
          <div id="content">
              ...
              <!--<form action="http://localhost/sportssystem/index.php/patron/search_student" method="post">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
                  ...
                  <div class="mdl-textfield__expandable-holder">
                    <input class="mdl-textfield__input" type="text" id="sample6" placeholder="Search here" required />
            ...
            <div class="" id="welcome">
              <?php 
              if(!empty($res)){
                echo '<div>Showing results for '.count($res).' student(s)!</div>';
              ?>
              <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                <tr><th class="mdl-data-table__cell--non-numeric">Name</th><th class="mdl-data-table__cell--non-numeric">Reg. No.</th><th class="mdl-data-table__cell--non-numeric">Phone</th><th class="mdl-data-table__cell--non-numeric">E-mail</th></tr>
                <?php 
                foreach($res as $r){
                  echo '<tr><td class="mdl-data-table__cell--non-numeric">'.$r->username.'</td><td class="mdl-data-table__cell--non-numeric">'.$r->regno.'</td><td class="mdl-data-table__cell--non-numeric">'.$r->phone.'</td><td class="mdl-data-table__cell--non-numeric">'.$r->email.'</td></tr>';
                }
                ?>
              </table>
              <?php
              ...
              ?>
              <div class="alert alert-danger"role="alert"><span class="fa fa-ok-sign" aria-hidden="true"></span><span class="sr-only">Error:</span>No matches found!</div>
              <?php  
              }
              ?>
