...
$tags=array("","Shirts","Trousers","Sweaters","Phone","Laptop","Computers","Shoes","Television","Radios","Speakers","Dresses");
...
<body>
    ...
    <div class="container main">
      <form action="http://localhost/legrand/admin/add_new_product"method="POST"class="form">
