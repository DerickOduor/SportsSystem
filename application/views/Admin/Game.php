      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div><h3>Game:&nbsp;<?php echo $game;?></h3></div>
          </div>  
          <div class="w-100">
             <div class="">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $game;?></li>
              </ol>
            </nav>
              <div class="row">
            ...
            if(isset($res)){
              if(count($res)>0){
                ...
                foreach($res as $r){
                  $game_name=$r->name;
                  echo '<li class="list-group-item">In-charge:&nbsp;'.$r->patron.'</li>
                        <li class="list-group-item">Registered on:&nbsp;'.$r->day_established.'</li>';
                }
                $n_s=0;
                if(isset($game_student)){
                  if(count($game_student)>0){
                    foreach($game_student as $g){
                      $n_s=count($game_student);
                    }
                    echo '<li class="list-group-item">No. of students:&nbsp;'.count($game_student).'&nbsp;<a href="http://localhost/sportssystem/index.php/admin/game_students/'.$game.'" class="btn btn-outline-info"><span data-feather="clipboard"></span>&nbsp;View students</a></li>';
                  }else{
                    echo '<li class="list-group-item">No. of students:&nbsp;'.count($game_student).'&nbsp;</li>';
                  }
                }else{}
                echo '</ul>';  
              }else{}
