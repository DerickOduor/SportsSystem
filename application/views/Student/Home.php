      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link active" href="http://localhost/sportssystem/index.php/student/">
                  <span data-feather="home"></span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="http://localhost/sportssystem/index.php/student/myactivities">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php echo $this->session->userdata('student_logged');?>&nbsp;-&nbsp;<?php echo $this->session->userdata('student_regno');?></h1>
